...
function renderPage(org, empIdSettings) {
  ...
  const logoHTML = org.has_logo || org.logo_data
    ? '<img src="/api/v2/organisation/logo" class="org-logo-img" alt="Logo">'
