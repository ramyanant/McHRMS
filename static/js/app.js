  ...
  login.innerHTML =
    '<div class="login-card">' +
      '<div class="login-logo">' +
        '<img src="/static/img/logo.png?v=20260521l" alt="McHR&amp;TA" ' +
...
function buildSidebar() {
  ...
  document.getElementById('sidebar').innerHTML =
    ...
    '<div class="sidebar-user">' +
      '<img class="user-av" src="' + ((_user && (_user.photo_url || (_user.emp && _user.emp.photo_url))) || ('https://api.dicebear.com/7.x/avataaars/svg?seed=' + encodeURIComponent(String(uname||'user').trim().toLowerCase() || 'user'))) + '" alt="' + ini + '" style="object-fit:cover" onerror="this.onerror=null;this.outerHTML=\'<div class=&quot;user-av ' + getUserAvColor() + '&quot;>' + ini + '</div>\'">' +
      '<div class="user-info">' +
...
async function registerRoutes() {
  ...
  const load = (mod, fn) => async (params) => {
    const m = await import('./pages/' + mod + '.js?v=20260521l');
    await m[fn](params);
